...
public class FrmMain1 extends javax.swing.JFrame {
    private int tries=5 , hint = 5;
    Random random = new Random();
    String[] wordBank = {"HELP","LOVE","KIND"};
    String decision = "N";
    ...
    String bookT1 = "1 Chronicles 16:11"; String bookT2 = "1 Corinthians 13:13 "; String bookT3 = "Ephesians 4:32 ";
    String verse1 = "Depend on the Lord for strength. Always go to him for ______.";
    String verse2 = "“And now these three remain: faith, hope and love. "+" \n But the greatest of these is _____.”";
    String verse3 = "“Be _____ and compassionate to one another, forgiving " + "\n each other, just as in Christ God forgave you.”";
    public FrmMain1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        guess0.setText("-");
        getContentPane().add(guess0, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 230, -1, -1));

        guess1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        guess1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        guess1.setText("-");
        getContentPane().add(guess1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 230, -1, -1));

        guess2.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        guess2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        guess2.setText("-");
        getContentPane().add(guess2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 230, -1, -1));

        guess3.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        guess3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        guess3.setText("-");
        getContentPane().add(guess3, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 230, -1, -1));
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, -1, -1));
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        main2.show();
        dispose();
        FrmMain2.hint_txt.setText(hint_txt.getText());
        FrmMain2.name.setText(name.getText());
        
        if(heart_5.isVisible() == false){
             FrmMain2.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain2.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain2.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain2.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain2.heart_1.setVisible(false);  
         }
        
        
        if(devil1.isVisible() == true){
            FrmMain2.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain2.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain2.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain2.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain2.devil5.setVisible(true);
        }
    ...
    private javax.swing.JLabel heart_1;
    private javax.swing.JLabel heart_2;
    private javax.swing.JLabel heart_3;
    private javax.swing.JLabel heart_4;
    private javax.swing.JLabel heart_5;
