...
public class FrmMain9 extends javax.swing.JFrame {
    private int tries=5,hint;
    Random random = new Random();
    String[] wordBank = {"COURAGE","TROUBLE","PERFECT"};
    String decision = "N";
    ...
    String bookT1 = "Psalm 31:24"; String bookT2 = "Nahum 1:7"; String bookT3 = "Isaiah 26:3";
    String verse1 = "“Be strong, and let your heart take _______, all you who wait "
            + "\n for the Lord” ";
    String verse2 = "The LORD is good, a stronghold in the day of _______; he knows "
            + "\n those who take refuge in him ";
    String verse3 = "“You keep him in ________ peace whose mind is stayed on you, "
    ...
    private void initComponents() {
        ...
        guess6.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        guess6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        guess6.setText("-");
        getContentPane().add(guess6, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 230, -1, -1));
    ...
    private void AActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AActionPerformed
        ...
        if(!"-".equals(guess0.getText()) && !"-".equals(guess1.getText()) && !"-".equals(guess2.getText()) && !"-".equals(guess3.getText())
                && !"-".equals(guess4.getText()) && !"-".equals(guess5.getText())  && !"-".equals(guess6.getText())   ){
    ...
    private void hint_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hint_btnActionPerformed
        ...
        if(!"-".equals(guess0.getText()) && !"-".equals(guess1.getText()) && !"-".equals(guess2.getText()) && !"-".equals(guess3.getText()) && !"-".equals(guess4.getText())&& !"-".equals(guess5.getText())&& !"-".equals(guess6.getText())      ){
            Next_B.setVisible(true);
        }
        }else{
            hint_txt.setText("0");
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain10 main10 = new FrmMain10();
        main10.show();
        dispose();
        FrmMain10.hint_txt.setText(hint_txt.getText());
        FrmMain10.name.setText(name.getText());
        if(heart_5.isVisible() == false){
             FrmMain10.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain10.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain10.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain10.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain10.heart_1.setVisible(false);  
         }
        
        
        if(devil1.isVisible() == true){
            FrmMain10.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain10.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain10.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain10.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain10.devil5.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMain9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static javax.swing.JLabel lvl_txt;
