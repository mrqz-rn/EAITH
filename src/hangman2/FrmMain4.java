...
public class FrmMain4 extends javax.swing.JFrame {
    ...
    String[] wordBank = {"RESCUES","CREATED","PROTECT"};
    String decision = "N";
    ...
    String bookT1 = "1 Samuel 17:47"; String bookT2 = "Genesis 1:1"; String bookT3 = "Numbers 6:24";
    String verse1 = "“And everyone assembled here will know that the Lord "
            + "\n _______ his people, but not with sword and spear. This is "
            + "\n the Lord’s battle, and he will give you to us!” ";
    String verse2 = "In the beginning God _______ the heavens and the earth. ";
    String verse3 = "“May the Lord bless you and _______ you.”";
    public FrmMain4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, -1, -1));
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain5 main5 = new FrmMain5();
        main5.show();
        dispose();
        FrmMain5.hint_txt.setText(hint_txt.getText());
        FrmMain5.name.setText(name.getText());
        if(heart_5.isVisible() == false){
             FrmMain5.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain5.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain5.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain5.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain5.heart_1.setVisible(false);  
         }
        
        
        if(devil1.isVisible() == true){
            FrmMain5.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain5.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain5.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain5.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain5.devil5.setVisible(true);
        }
