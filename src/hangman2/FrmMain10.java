...
public class FrmMain10 extends javax.swing.JFrame {
    private int tries=5,hint;
    Random random = new Random();
    String[] wordBank = {"FAITH","HONOR","HEART"};
    String decision = "N";
    ...
    String bookT1 = "1 Corinthians 16:13"; String bookT2 = "1 Chronicles 29:12"; String bookT3 = "Mark 12:30";
    String verse1 = "“Be watchful, stand firm in the ______, act like men, be strong.”";
    String verse2 = "Both riches and ______ come from you, and you rule over all. "
            + "\n In your hand are power and might, and in your hand it is to make "
            + "\n great and to give strength to all.";
    String verse3 = "“And you shall love the Lord your God with all your _______ and "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMain10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
