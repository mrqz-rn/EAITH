...
public class FrmMain6 extends javax.swing.JFrame {
    private int tries=5,hint;
    Random random = new Random();
    String[] wordBank = {"LORD","FAIL","GIVE"};
    String decision = "N";
    ...
    String bookT1 = "Ephesians 6:10"; String bookT2 = "Psalm 73:26 "; String bookT3 = "Psalm 29:11 ";
    String verse1 = "“Finally, be strong in the _____ and in the strength of his might.”";
    String verse2 = "“My flesh and my heart may _____, but God is the strength "
            + "\n of my heart and my portion forever.”";
    String verse3 = "“May the Lord _____ strength to his people! May the "
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, -1, -1));
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain7 main7 = new FrmMain7();
        main7.show();
        dispose();
        FrmMain7.hint_txt.setText(hint_txt.getText());
        FrmMain7.name.setText(name.getText());
        if(heart_5.isVisible() == false){
             FrmMain7.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain7.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain7.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain7.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain7.heart_1.setVisible(false);  
         }
        
        
        if(devil1.isVisible() == true){
            FrmMain7.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain7.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain7.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain7.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain7.devil5.setVisible(true);
        }
