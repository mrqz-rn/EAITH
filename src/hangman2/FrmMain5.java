...
public class FrmMain5 extends javax.swing.JFrame {
    private int tries=5,hint;
    Random random = new Random();
    String[] wordBank = {"FIGHT","HEART","LEAVE"};
    String decision = "N";
    ...
    String bookT1 = "Exodus 14:14"; String bookT2 = "Deuteronomy 6:5"; String bookT3 = "Joshua 1:5";
    String verse1 = "“The Lord will _____ for you. All you have to do is keep still.”";
    String verse2 = "Love the Lord your God with all your _____, all your soul, "
            + "\n and all your strength.";
    String verse3 = "“No one will be able to defeat you all your life. Just "
            + "\n as I was with Moses, so I will be with you. I will not "
            + "\n _____ you or forsake you.”";
    public FrmMain5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, -1, -1));
    ...
    private void hint_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hint_btnActionPerformed
        ...
        if(!"-".equals(guess0.getText()) && !"-".equals(guess1.getText()) && !"-".equals(guess2.getText()) && !"-".equals(guess3.getText())  && !"-".equals(guess4.getText())){
            Next_B.setVisible(true);
        }
        }else{
            hint_txt.setText("0");
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain6 main6 = new FrmMain6();
        main6.show();
        dispose();
        FrmMain6.hint_txt.setText(hint_txt.getText());
        FrmMain6.name.setText(name.getText());
        if(heart_5.isVisible() == false){
             FrmMain6.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain6.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain6.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain6.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain6.heart_1.setVisible(false);  
         }
        
        if(devil1.isVisible() == true){
            FrmMain6.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain6.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain6.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain6.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain6.devil5.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMain5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
