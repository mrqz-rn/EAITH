...
import static hangman2.FrmMain1.name;
...
public class FrmMain3 extends javax.swing.JFrame {
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain4 main4 = new FrmMain4();
        main4.show();
        dispose();
        FrmMain4.hint_txt.setText(hint_txt.getText());
        FrmMain4.name.setText(name.getText());
        if(heart_5.isVisible() == false){
             FrmMain4.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain4.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain4.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain4.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain4.heart_1.setVisible(false);  
         }
        
        if(devil1.isVisible() == true){
            FrmMain4.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain4.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain4.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain4.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain4.devil5.setVisible(true);
        }
