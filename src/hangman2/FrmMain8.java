...
public class FrmMain8 extends javax.swing.JFrame {
    private int tries=5;
    public int hint;
    
    
    Random random = new Random();
    String[] wordBank = {"POWER","FAINT","LIGHT"};
    String decision = "N";
    ...
    String bookT1 = "2 Timothy 1:7"; String bookT2 = "Isaiah 40:29"; String bookT3 = "Psalm 27:1";
    String verse1 = "“For God gave us a spirit not of fear but of _____ and love and self-control”";
    String verse2 = "“He gives power to the _____, and to him who has no might he "
            + "\n increases strength”";
    String verse3 = "“The Lord is my _____ and my salvation; whom shall I fear? The Lord "
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, -1, -1));
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain9 main9 = new FrmMain9();
        main9.show();
        dispose();
        FrmMain9.hint_txt.setText(hint_txt.getText());
        FrmMain9.name.setText(name.getText());
        if(heart_5.isVisible() == false){
             FrmMain9.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain9.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain9.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain9.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain9.heart_1.setVisible(false);  
         }
        
        
        if(devil1.isVisible() == true){
            FrmMain9.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain9.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain9.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain9.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain9.devil5.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMain8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
