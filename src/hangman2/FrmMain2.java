...
public class FrmMain2 extends javax.swing.JFrame {
    ...
    String[] wordBank = {"HUMBLE","SPIRIT","HATRED"};
    String decision = "N";
    ...
    String bookT1 = "Ephesians 4:2"; String bookT2 = "Romans 5:5"; String bookT3 = "Proverbs 10:12";
    String verse1 = "“Be completely ______ and gentle; be patient, bearing with" + "\n" + "one another in love.”";
    String verse2 = "“God’s love has been poured out into " + "\n" + " our hearts through the Holy ______, who has been given to us.”";
    String verse3 = "“______ stirs up conflict, but love " + "\n" + " covers all wrongs.”";
    public FrmMain2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, -1, -1));
    ...
    private void Next_BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BActionPerformed
        ...
        FrmMain3 main3 = new FrmMain3();
        main3.show();
        dispose();
        FrmMain3.hint_txt.setText(hint_txt.getText());
        FrmMain3.name.setText(name.getText());
        
        if(heart_5.isVisible() == false){
             FrmMain3.heart_5.setVisible(false);  
         }
        if(heart_4.isVisible() == false){
             FrmMain3.heart_4.setVisible(false);  
         }
        if(heart_3.isVisible() == false){
             FrmMain3.heart_3.setVisible(false);  
         }
        if(heart_2.isVisible() == false){
             FrmMain3.heart_2.setVisible(false);  
         }
        if(heart_1.isVisible() == false){
             FrmMain3.heart_1.setVisible(false);  
         }
        
        
        if(devil1.isVisible() == true){
            FrmMain3.devil1.setVisible(true);
        }
        if(devil2.isVisible() == true){
            FrmMain3.devil2.setVisible(true);
        }
        if(devil3.isVisible() == true){
            FrmMain3.devil3.setVisible(true);
        }
        if(devil4.isVisible() == true){
            FrmMain3.devil4.setVisible(true);
        }
        if(devil5.isVisible() == true){
            FrmMain3.devil5.setVisible(true);
        }
